...
@Component({
  selector: 'app-guest-the-numbers',
  templateUrl: './guest-the-numbers.page.html',
  styleUrls: ['./guest-the-numbers.page.scss'],
})
export class GuestTheNumbersPage implements OnInit {

  showWelcomeMessage: boolean = true;
  hearts: number = 3;
  animals: { name: string, image: string }[] = [
    { name: 'One', image: 'assets/numbers/One.png' },
    { name: 'Two', image: 'assets/numbers/Two.png' },
    { name: 'Three', image: 'assets/numbers/Three.png' },
    { name: 'Four', image: 'assets/numbers/Four.png' },
    { name: 'Five', image: 'assets/numbers/Five.png' },
    { name: 'Six', image: 'assets/numbers/Six.png' },
    { name: 'Seven', image: 'assets/numbers/Seven.png' },
    { name: 'Eight', image: 'assets/numbers/Eight.png' },
    { name: 'Nine', image: 'assets/numbers/Nine.png' },
    { name: 'Ten', image: 'assets/numbers/Ten.png' },
